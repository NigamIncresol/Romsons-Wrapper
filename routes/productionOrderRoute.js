...
router.get("/getJobCardList/:employeeId/:plant/:sessionId", async (req, res) => {
  console.log(
    "🟢 Get Job Card List request received",
    "/productionOrder/getJobCardList",
  );
  await productionOrderController.getJobCardList(req, res);
});
